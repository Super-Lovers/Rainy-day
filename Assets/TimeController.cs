...
{
    [SerializeField]
    private TextMeshProUGUI clock_text;

    [Header("Environmental elements")]
    [SerializeField]
    private GameObject background_elements;
    ...
    private void DarkenBackgroundElements() {
        ...
        for (int i = 0; i < background_elements.transform.childCount; i++) {
            Renderer element_shader = background_elements.transform.GetChild(i).GetComponent<Renderer>();
